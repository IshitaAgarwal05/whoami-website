...
export interface ApiAnnouncementAnnouncement
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<['info', 'promo', 'critical']> &
...
export interface ApiAuditLogAuditLog extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Schema for audit-log';
...
export interface ApiBlogBlog extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    soft_deleted: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
...
export interface ApiContactSubmissionContactSubmission
  ...
  info: {
    description: 'Schema for contact-submission';
  ...
  attributes: {
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    reply_status: Schema.Attribute.String &
...
export interface ApiCouponCoupon extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    min_purchase: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiHomepageHomepage extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Schema for homepage';
...
export interface ApiInventoryTransactionInventoryTransaction
  extends Struct.CollectionTypeSchema {
  collectionName: 'inventory_transactions';
  info: {
    description: 'Schema for inventory-transaction';
    displayName: 'Inventory Transaction';
    pluralName: 'inventory-transactions';
    singularName: 'inventory-transaction';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    product_sku: Schema.Attribute.String & Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    quantity: Schema.Attribute.Integer & Schema.Attribute.Required;
    reference_id: Schema.Attribute.String;
    type: Schema.Attribute.Enumeration<
      ['incoming', 'outgoing', 'manual_adjustment', 'sale', 'return']
    > &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  info: {
    description: 'Schema for navigation';
...
export interface ApiNewsletterSubscriberNewsletterSubscriber
  ...
  info: {
    description: 'Schema for newsletter-subscriber';
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    coupon_used: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    customer_notes: Schema.Attribute.Text;
    discount_applied: Schema.Attribute.Decimal & Schema.Attribute.DefaultTo<0>;
    ...
    order_number: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique;
    packing_status: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'pending'>;
    payment_method: Schema.Attribute.String;
    payment_reference_id: Schema.Attribute.String;
    ...
    status: Schema.Attribute.String & Schema.Attribute.DefaultTo<'unfulfilled'>;
    tax_breakdown: Schema.Attribute.JSON;
...
export interface ApiProductProduct extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    delivery_estimate: Schema.Attribute.String;
    description: Schema.Attribute.RichText;
    dimensions: Schema.Attribute.String;
    dispatch_time: Schema.Attribute.String;
    featured_order: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    ...
    material_options: Schema.Attribute.JSON;
    mrp: Schema.Attribute.Decimal;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    printing_time: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    ...
    selling_price: Schema.Attribute.Decimal & Schema.Attribute.Required;
...
export interface ApiSiteConfigurationSiteConfiguration
  ...
  collectionName: 'site_configuration';
  info: {
    description: 'Schema for site-configuration';
  ...
  attributes: {
    brand_email: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    privacy_policy: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
    return_policy: Schema.Attribute.Text;
    seo_defaults: Schema.Attribute.JSON;
...
export interface ApiTestimonialTestimonial extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Schema for testimonial';
