                ...
                <div className="contact-grid">
                    ...
                    <div className="contact-info-section">
                        ...
                        <div className="contact-cards-stack">
                            ...
                            <a href="https://www.facebook.com/people/Whoami-Studios/61588942346952/" target="_blank" rel="noopener noreferrer" className="contact-info-card">
                                ...
                                <div className="card-content">
                                    <span className="card-label">Facebook</span>
                                    <span className="card-value">WhoAmI Studios</span>
                                </div>
                                <div className="card-arrow">→</div>
                            </a>
